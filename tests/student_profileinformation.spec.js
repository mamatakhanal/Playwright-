...
//     await expect(page).toHaveURL("https://staging.advisebridge.com/student/students/1609?tab=-profile-tab");
...
//     await expect(page).toHaveURL("https://staging.advisebridge.com/student/students/1609?tab=-address-tab");
...
//     await expect(page).toHaveURL("https://staging.advisebridge.com/student/students/1609?tab=-language-tab");
//     await page.waitForTimeout(2000);
...
//     await expect(page).toHaveURL("https://staging.advisebridge.com/student/students/1609?tab=-gpa-kse-tab");
//     await page.waitForTimeout(2000);
//     // GPA Scale
...
//     await expect(page).toHaveURL("https://staging.advisebridge.com/student/students/1609?tab=-academics-tab");
//     await page.waitForTimeout(2000);
...
//     await expect(page).toHaveURL("https://staging.advisebridge.com/student/students/1609?tab=-documents-tab");
//     await page.waitForTimeout(2000);
...
//     await expect(page).toHaveURL("http://staging.advisebridge.com/student/students/1609?tab=-emergency-tab");
//     await page.waitForTimeout(2000);
...
//     await expect(page).toHaveURL("https://staging.advisebridge.com/student/students/1609?tab=-consent-tab");
//     await page.waitForTimeout(2000);
